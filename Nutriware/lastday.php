...
$username="panos";$password="123456";$database="nutriware";
    ...
    $sql2="SELECT * FROM `general` WHERE `cid` = '$cid'";
    ...
    <body>
      ...
      <nav class='navbar navbar-default' style='background-color:inherit; border:none; '>
        ...
        <div id='bread' class='pull-left'>
            ...
            <li class='active'>Προβολη Διατροφικου 24ώρου</li>        
          </ol>
        </div>
...
<div class='container'>
    <br><br>
    <h2>Δεν βρέθηκε καταγραφή για το διατροφικό 24ωρο του πελάτη ". $row1['Fname']. " ". $row1['Lname']." </h2>
</div>
      ...
      <nav class='navbar navbar-default' style='background-color:inherit; border:none; '>
        ...
        <div id='bread' class='pull-left'>
            ...
            <li><a href='profile.php'>Σύνδεση</a></li>
             <li><a href='clients.php'>Οι πελάτες μου</a></li>
               <li><a href='clients.php'>Περισσότερα</a></li>
            <li class='active'>Προβολή Διατροφικού 24ωρου</li>        
          </ol>
        </div>
        <!-- -main content- -->
<div class='container'>
 ...
 <div id='table1' > 
            ...
            <table class='table'>
              <tr>
             <th>Πρωινό &emsp;&emsp;</th>
            <td> ".$row2['proino']." </td>
          
         </tr>
         
         <tr>
         <th>Δεκατιανό &emsp;&emsp;</th>
         <td> ".$row2['dekatiano']." </td>
         </tr>
         
         <tr>
         <th>Μεσημεριανό &emsp;&emsp;</th>
         <td> ".$row2['mesimeriano']." </td>
         </tr>
         
         <tr>
         <th>Απογευματινό &emsp;&emsp;</th>
         <td> ".$row2['apogeumatino']." </td>
         </tr>
         
         <tr>
         <th>Βραδινό &emsp;&emsp;</th>
         <td> ".$row2['vradino']." </td>
         </tr>
