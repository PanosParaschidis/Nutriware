...
if(mysqli_num_rows($result01)==0 ){
 ...
 $row01=mysqli_fetch_assoc($result01);
  $did=$row01['Did'];
   ...
   $sql_day="SELECT * FROM `day` WHERE `Number` = 1 and `Did`='$did' and `Date`='$date' ";
$res_day= mysqli_query($conn, $sql_day);
$row3=mysqli_fetch_assoc($res_day);
   echo "<h3>1η Ημέρα: </h3><br>
       <h4> Πρωινό: ".$row3['Proino']." </h4> <br>
       <h4>  Δεκατιανό: ".$row3['Dekatiano']." </h4><br> 
        <h4> Μεσημεριανό: ".$row3['Mesimeriano']." </h4><br>
       <h4>  Απογευματινό: ".$row3['Apogeumatino']." </h4><br>
       <h4>  Βραδινό: ".$row3['Vradino']." </h4><br>";

    $sql_day2="SELECT * FROM `day` WHERE `Number` = 2 and `Did`='$did' and `Date`='$date' ";
$res_day2= mysqli_query($conn, $sql_day2);
$row32=mysqli_fetch_assoc($res_day2);
   echo "<h3>2η Ημέρα: </h3><br>
       <h4> Πρωινό: ".$row32['Proino']." </h4> <br>
       <h4>  Δεκατιανό: ".$row32['Dekatiano']." </h4><br> 
        <h4> Μεσημεριανό: ".$row32['Mesimeriano']." </h4><br>
       <h4>  Απογευματινό: ".$row32['Apogeumatino']." </h4><br>
       <h4>  Βραδινό: ".$row32['Vradino']." </h4><br>";
   
    $sql_day3="SELECT * FROM `day` WHERE `Number` = 3 and `Did`='$did' and `Date`='$date' ";
$res_day3= mysqli_query($conn, $sql_day3);
$row33=mysqli_fetch_assoc($res_day3);
   echo "<h3>3η Ημέρα: </h3><br>
       <h4> Πρωινό: ".$row33['Proino']." </h4> <br>
       <h4>  Δεκατιανό: ".$row33['Dekatiano']." </h4><br> 
        <h4> Μεσημεριανό: ".$row33['Mesimeriano']." </h4><br>
       <h4>  Απογευματινό: ".$row33['Apogeumatino']." </h4><br>
       <h4>  Βραδινό: ".$row33['Vradino']." </h4><br>";
   
    $sql_day4="SELECT * FROM `day` WHERE `Number` = 4 and `Did`='$did' and `Date`='$date' ";
$res_day4= mysqli_query($conn, $sql_day4);
$row34=mysqli_fetch_assoc($res_day4);
   echo "<h3>4η Ημέρα: </h3><br>
       <h4> Πρωινό: ".$row34['Proino']." </h4> <br>
       <h4>  Δεκατιανό: ".$row34['Dekatiano']." </h4><br> 
        <h4> Μεσημεριανό: ".$row34['Mesimeriano']." </h4><br>
       <h4>  Απογευματινό: ".$row34['Apogeumatino']." </h4><br>
       <h4>  Βραδινό: ".$row34['Vradino']." </h4><br>";
   
    $sql_day5="SELECT * FROM `day` WHERE `Number` = 5 and `Did`='$did' and `Date`='$date' ";
$res_day5= mysqli_query($conn, $sql_day5);
$row35=mysqli_fetch_assoc($res_day5);
   echo "<h3>5η Ημέρα: </h3><br>
       <h4> Πρωινό: ".$row35['Proino']." </h4> <br>
       <h4>  Δεκατιανό: ".$row35['Dekatiano']." </h4><br> 
        <h4> Μεσημεριανό: ".$row35['Mesimeriano']." </h4><br>
       <h4>  Απογευματινό: ".$row35['Apogeumatino']." </h4><br>
       <h4>  Βραδινό: ".$row35['Vradino']." </h4><br>";
   
    $sql_day6="SELECT * FROM `day` WHERE `Number` = 6 and `Did`='$did' and `Date`='$date' ";
$res_day6= mysqli_query($conn, $sql_day6);
$row36=mysqli_fetch_assoc($res_day6);
   echo "<h3>6η Ημέρα: </h3><br>
       <h4> Πρωινό: ".$row36['Proino']." </h4> <br>
       <h4>  Δεκατιανό: ".$row36['Dekatiano']." </h4><br> 
        <h4> Μεσημεριανό: ".$row36['Mesimeriano']." </h4><br>
       <h4>  Απογευματινό: ".$row36['Apogeumatino']." </h4><br>
       <h4>  Βραδινό: ".$row36['Vradino']." </h4><br>";
   
    $sql_day7="SELECT * FROM `day` WHERE `Number` = 7 and `Did`='$did' and `Date`='$date' ";
$res_day7= mysqli_query($conn, $sql_day7);
$row37=mysqli_fetch_assoc($res_day7);
   echo "<h3>7η Ημέρα: </h3><br>
       <h4> Πρωινό: ".$row37['Proino']." </h4> <br>
       <h4>  Δεκατιανό: ".$row37['Dekatiano']." </h4><br> 
        <h4> Μεσημεριανό: ".$row37['Mesimeriano']." </h4><br>
       <h4>  Απογευματινό: ".$row37['Apogeumatino']." </h4><br>
       <h4>  Βραδινό: ".$row37['Vradino']." </h4><br>";
}
  }
   ?>
  </div>
