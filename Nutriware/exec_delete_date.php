...
$username="panos";$password="123456";$database="nutriware";
    ...
    mysqli_set_charset($conn, "utf8");
        ...
        $sql0="SELECT * FROM `events` WHERE `Eid` = '$eid' ";
      $result0= mysqli_query($conn, $sql0);
      $record =mysqli_fetch_assoc($result0);
$time=$record['Time'];
$name=$record['Name'];
$date=date('d-m-Y', strtotime($record['Date']));

        $sql="DELETE FROM `events` WHERE `events`.`Eid` = '$eid' ";
    ...
    <body>
      ...
      <nav class='navbar navbar-default' style='background-color:inherit; border:none; '>
        ...
        <div id='bread' class='pull-left'>
            ...
            <li class='active'>Διαχείριση Ραντεβού</li>        
          </ol>
        </div>
        
        <div class='container-fluid' id='cont2'>
        <br><br><br><h2>Το ραντεβού του πελάτη ".$name." ". "για τις " .$date." ".$time."  έχει διαγραφεί</h2>
