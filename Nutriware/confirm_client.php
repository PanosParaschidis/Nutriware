...
<body>
 ...
 <br><br>
        <h2>Είστε σίγουροι οτι θέλετε να διαγράψετε τον λογαριασμό του ".$cname." ;</h2>
 <br><br>
                  <div class='col-sm-offset-2 col-sm-2'>
                 <button class='btn btn-default' id='delete' onclick='delete_client();'>Ναι</button>
       &emsp; &emsp; &emsp;    
    ...
    window.location=\"delete_client.php\";
}
function back(){
