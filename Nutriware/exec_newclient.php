...
$Npwd=$_SESSION["pwd"];
  $find_user="SELECT * FROM `nutritionist` WHERE `Username` = '$Nuname' AND `Password` = '$Npwd'  ";
      $Nresult= mysqli_query($conn, $find_user);
    ...
    $weight0=filter_input(INPUT_POST, 'weight');
    $weight= str_replace(',', '.', $weight0);
    $fat0=filter_input(INPUT_POST, 'fat');
    $fat= str_replace(',', '.', $fat0);
    ...
    $result0= mysqli_query($conn, $find_user0);
     ...
     $find_user01="SELECT * FROM `client` WHERE `Email` = '$email'";
   ...
   $flag01=0;
     ...
     $flag1=0;
     $flag2=0;
   if(empty($fname) or empty($lname) or empty($tel) or empty($sex)){
   $flag1=1;
echo "
    <html>
                     <head>
  ...
  <script src='https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js'></script>
    ...
    <body>
     ...
     <!---main content--->
      ...
      <br><br>
                 <h2>Ολα τα υποχρεωτικά πεδία πρέπει να συμπληρωθούν για την εγγραφή πελάτη, παρακαλώ συμπληρώστε τα και ξαναπροσπαθήστε.</h2>
...
<link rel='icon' href='favicon.ico' type='image/x-icon'>
  ...
  <script src='https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js'></script>
    ...
    <body>
     ...
     <!---main content--->
            ...
            <div class='container-fluid' id='cont2'  >
      <br><br>
                 <h2>Το Username που επιλέχθηκε απο το σύστημα, χρησιμοποιείται ήδη. Παρακαλώ δοκιμάστε ξανά.</h2>
 ...
 <!---end main--->
  ...
  <footer class='footer' id='footer' >
     ...
     if(mysqli_num_rows($result01)>0 and $flag0==0 and $flag1==0 and !empty($email)){
...
<link rel='icon' href='favicon.ico' type='image/x-icon'>
    ...
    <body>
      ...
      <nav class='navbar navbar-default' style='background-color:inherit; border:none; '>
        ...
        <div id='bread' class='pull-left'>
            ...
            <li><a href='profile.php'>Αρχική</a></li>
            <li><a href='profile.php'>Σύνδεση</a></li>
            <li class='active'>Νέος Πελάτης</li>        
          </ol>
        </div>
 ...
 <!---end main--->
  ...
  <footer class='footer' id='footer' >
    ...
    if($flag0==0 and $flag01==0 and $flag1==0){
    
      if($email==''){
        
          $sql="INSERT INTO `client` (`Fname`,`Lname`,`Username`, `Password`,`telephone`,`Nid`) VALUES ('$fname','$lname','$uname','$pwd',  '$tel','$Nid')";
      }else{
          
           $sql="INSERT INTO `client` (`Fname`,`Lname`,`Username`, `Password`, `Email`,`telephone`,`Nid`) VALUES ('$fname','$lname','$uname','$pwd',  '$email','$tel','$Nid')";
      }
         
        $result= mysqli_query($conn, $sql);
   
        $sql0="SELECT * FROM `client` WHERE `Username` = '$uname' AND `Password` = '$pwd'  ";
        $result0= mysqli_query($conn, $sql0);
        $row1= mysqli_fetch_assoc($result0);
        $cid=$row1['Cid'];
        $breakfast1=nl2br($breakfast);
        $dekatiano1=nl2br($dekatiano);
        $lunch1=nl2br($lunch);
        $apogeumatino1=nl2br($apogeumatino);
        $diner1=nl2br($diner);
        
        $aller1=str_replace("\r\n","<br />",$aller);
        $disease1=str_replace("\r\n","<br />",$disease);
        $goals1=str_replace("\r\n","<br />",$goals);
        $drugs1=str_replace("\r\n","<br />",$drugs);
        $info1=str_replace("\r\n","<br />",$info);
        $sql1="INSERT INTO `general` (`Stoxoi`,`Varos`, `BMI`, `Lipos`,`Allergies`,`Astheneies`,`Cid`,`Sex`,`Age`,`Drugs`,`Height`,`proino`,`dekatiano`,`mesimeriano`,`apogeumatino`,`vradino`,`info`) VALUES ('$goals1','$weight','$bmi',  '$fat','$aller1','$disease1','$cid','$sex','$age','$drugs1','$height','$breakfast1','$dekatiano1','$lunch1','$apogeumatino1','$diner1','$info1')";
...
<link rel='icon' href='favicon.ico' type='image/x-icon'>
  ...
  <script src='https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js'></script>
   ...
   <div class='container-fluid' id='cont2'  >
      ...
      <br><br>
                 <h2>Συγχαρητήρια!</h2>
                 <h2>Η εγγραφή του πελάτη σας ολοκληρώθηκε με επιτυχία, τα στοιχεία του είναι:</h2>
                 <br>
                 <h2>Username: ".$uname."<h2>
                 <h2>Password: ".$pwd."<h2>
                 <h4 style='  font-family: Berlin Sans Fb; padding-left: 200px; font-weight:normal;'>Προσοχή! Με αυτά τα στοιχεία ο πελάτης σας έχει πρόσβαση στο Nutriware, ενημερώστε τον για αυτά!</h4>
  ...
  <script src='https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js'></script>
    ...
    <body>
     ...
     <!---main content--->
           ...
           <div class='container-fluid' id='cont2'  >
      <br><br>
                 <h2>Η εγγραφή του πελάτη σας δεν πραγματοποιήθηκε, Παρακαλώ Προσπαθήστε ξανά.</h2>
